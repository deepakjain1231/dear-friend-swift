...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/FLUtilities/FLUtilities.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/NeatTipView/NeatTipView.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/StepperView/StepperView.framework"
