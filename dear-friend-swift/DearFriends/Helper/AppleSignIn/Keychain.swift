...
extension Keychain {
    static var bundleIdentifier: String {
        return Bundle.main.bundleIdentifier ?? "com.fooddelivery.yeschef"
    }
...
class KeychainManager {
    ...
    func storeLoginInfo(username: String, password: String) {
        DispatchQueue.global().async {
            let service = "DearFriendsService"  // A service name for your app
            let account = "DearFriendsAccount"  // An account name
...
//                SecItemDelete(query as CFDictionary)  // Delete any existing data
    ...
    func deleteLoginInfo(username: String, password: String) {
        DispatchQueue.global().async {
            let service = "DearFriendsService"  // A service name for your app
            let account = "DearFriendsAccount"  // An account name
            let usernameKey = username.data(using: .utf8)
    ...
    func retrieveLoginInfo(completion: @escaping (String?, String?, Error?) -> Void) {
        let service = "DearFriendsService"
        let account = "DearFriendsAccount"
