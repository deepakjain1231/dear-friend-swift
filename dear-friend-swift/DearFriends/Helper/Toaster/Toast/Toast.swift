...
public class Toast {
    ...
    public static func text(
        _ title: String,
        subtitle: String? = nil,
        isForError: Bool = false,
        config: ToastConfiguration = ToastConfiguration()
    ) -> Toast {
        let view = AppleToastView(child: TextToastView(title, subtitle: subtitle), isForError: isForError)
    ...
    public static func `default`(
        ...
        let view = AppleToastView(
            child: IconAppleToastView(image: image, imageTint: imageTint, title: title, subtitle: subtitle), isForError: isForError
        )
        return self.init(view: view, config: config)
    }
