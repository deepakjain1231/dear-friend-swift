...
public final class DropDown: UIView {
	...
	*/
	@objc public dynamic var cornerRadiusNew = DPDConstant.UI.CornerRadius {
		willSet {
...
private extension DropDown {
	...
	func setupUI() {
		...
		tableViewContainer.layer.cornerRadius = cornerRadiusNew
		...
		tableView.layer.cornerRadius = cornerRadiusNew
...
extension DropDown {
	...
	public override func layoutSubviews() {
		...
		let shadowPath = UIBezierPath(roundedRect: tableViewContainer.bounds, cornerRadius: cornerRadiusNew)
