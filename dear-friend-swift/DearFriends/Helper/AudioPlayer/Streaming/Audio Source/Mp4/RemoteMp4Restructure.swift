...
final class RemoteMp4Restructure {
    ...
    /// [ftyp][moov][mdat]
    ///
    func optimizeIfNeeded(completion: @escaping (Swift.Result<RestructuredData?, Error>) -> Void) {
    ...
    func fetchAndRestructureMoovAtom(offset: Int, completion: @escaping (Swift.Result<(data: Data, offset: Int), Error>) -> Void) {
