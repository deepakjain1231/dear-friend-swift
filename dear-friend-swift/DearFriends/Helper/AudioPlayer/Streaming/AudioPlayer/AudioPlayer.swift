...
open class AudioPlayer {
    ...
    public func play(url: URL, seekingTIme: Double) {
        play(url: url, headers: [:], seekingTIme: seekingTIme)
    }
    ...
    public func play(url: URL, headers: [String: String], seekingTIme: Double) {
        let audioEntry = entryProvider.provideAudioEntry(url: url, headers: headers, seekingTIme: seekingTIme)
    ...
    public func queue(url: URL, headers: [String: String], after afterUrl: URL? = nil) {
        serializationQueue.sync {
            let audioEntry = entryProvider.provideAudioEntry(url: url, headers: headers, seekingTIme: 0)
            audioEntry.delegate = self
