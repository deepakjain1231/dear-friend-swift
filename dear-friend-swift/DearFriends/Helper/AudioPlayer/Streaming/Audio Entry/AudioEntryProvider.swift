...
protocol AudioEntryProviding {
    func provideAudioEntry(url: URL, headers: [String: String], seekingTIme: Double) -> AudioEntry
    func provideAudioEntry(url: URL, seekingTIme: Double) -> AudioEntry
}
...
final class AudioEntryProvider: AudioEntryProviding {
    ...
    func provideAudioEntry(url: URL, headers: [String: String], seekingTIme: Double) -> AudioEntry {
        ...
        return AudioEntry(source: source,
                          ...
                          outputAudioFormat: outputAudioFormat, seekingTIme: seekingTIme)
    }

    func provideAudioEntry(url: URL, seekingTIme: Double) -> AudioEntry {
        provideAudioEntry(url: url, headers: [:], seekingTIme: seekingTIme)
    }
